...
class LevelUpRepositoryTest {
    ...
    @Test
    public void shouldFindLevelUpByCustomerId(){
        ...
        LevelUp levelUp3 = new LevelUp(3, 10, DATE);
        LevelUp levelUpFromDb3 = levelUpRepository.save(levelUp3);
        levelUp3.setLevelUpId(levelUpFromDb3.getLevelUpId());

        assertEquals(levelUp1, levelUpRepository.findByCustomerId(1));
        assertEquals(levelUp2, levelUpRepository.findByCustomerId(2));
        assertEquals(levelUp3, levelUpRepository.findByCustomerId(3));
    }
